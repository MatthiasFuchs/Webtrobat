...
(function(window, undefined)
{
  ...
  (function(window, undefined)
  {
    ...
    expando = "sizzle" + -(new Date()), preferredDoc = window.document, support =
    {
    }, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(),
    ...
    function(prop, value)
    {
      ...
      if (parts)
      {
        ...
        if (unit !== "px" && start)
        {
          ...
          // Prefer the current property, because this process will be trivial if
          // it uses the same units
